...
/**
 * Klasa `GpsMovingAvgSmoothing` implementuje algorytm wygładzania danych GPS przy użyciu średniej ruchomej.
...
class GpsMovingAvgSmoothing(
    ...
    /**
     * Oblicza średnią odległość punktu od grupy.
     *
     * @param lat1 Szerokość geograficzna punktu.
     * @param lon1 Długość geograficzna punktu.
     * @param groupIndex Indeks grupy.
     * @param groupIndexMap Mapa grup i ich indeksów.
     * @param latitudes Tablica szerokości geograficznych.
     * @param longitudes Tablica długości geograficznych.
     * @return Średnia odległość do grupy.
     */
    ...
    /**
     * Wylicza średnią ruchomą dla punktu GPS.
     *
